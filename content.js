    ...
    pages: [
      ...
      },
      {
        ...
        practice: {
          kind: "build",
          fields: [
            { key: "aiRequest", label: "AI에게 보낼 요청문", placeholder: "예: 여행 준비 미니앱을 HTML+CSS+JS 한 파일로 만들어 줘. 준비물 체크리스트, 코스 후보 랜덤 추천, 교통비·식비·숙소비 예산 합계 기능이 있어야 해. API·로그인·DB는 넣지 말고, 모바일에서 보기 좋게 만들어 줘. <!DOCTYPE html>부터 </html>까지 전체를 줘." },
