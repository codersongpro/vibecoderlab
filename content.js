  ...
  rookie: {
    ...
    pages: [
      ...
      },
      {
        ...
        summary: "루키 PRD는 7번에서 AI에게 바로 붙여넣을 수 있는 앱 제작 요청문입니다.",
        reading: "PRD는 '내가 만들고 싶은 것 설명서'입니다. 앱 이름, 사용할 사람, 해결할 문제, 꼭 필요한 기능 3개, 성공 확인 방법만 정리해도 AI에게 훨씬 정확히 일을 맡길 수 있습니다. 이번 단계의 목표는 예쁜 문서가 아니라, 7번에서 AI에게 그대로 복사해 붙여넣을 수 있는 요청문을 완성하는 것입니다. 기능을 욕심내지 말고, 정말 필요한 3개만 골라 적으세요. 7번에서 결과가 한 번에 완성되지 않아도 괜찮습니다. 이 PRD를 기준으로 수정하고 디버그하는 과정이 핵심입니다.",
        terms: [
        ...
        steps: [
          ...
          "꼭 필요한 기능 3개를 적습니다.",
          "성공 확인 방법을 적습니다.",
          "7번에서 바로 붙여넣을 수 있도록 하나의 요청문으로 정리합니다."
        ],
        practice: {
          kind: "form",
          fields: [
      ...
      },
      {
        ...
        practice: {
          kind: "build",
          fields: [
            { key: "aiRequest", label: "6번 PRD 기반 AI 요청문", placeholder: "6번에서 만든 '7번에 붙여넣을 루키 PRD 요청문'을 여기에 붙여넣으세요." },
